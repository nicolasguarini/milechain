...
export default function SearchBar(){
    ...
    <div className="flex">
        ...
        <div className="relative w-full">
            <input type="search" id="search-dropdown" onChange={(e) => {setInput(e.target.value)}} className="block bg-darker text-primary p-2.5 w-full placeholder-primary-darker font-bold z-20 text-sm focus:border-2 focus:border-primary rounded-r-lg border-l-1 border border-primary" placeholder="Start browsing license plates.." required />
