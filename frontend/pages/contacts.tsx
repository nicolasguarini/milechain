      ...
      <Container>
        <div className="flex flex-row justify-between mt-20">
          <div className="flex flex-col content-start mr-5 w-full">
            ...
            <p>
              I am a passionate computer science student with a strong curiosity
              for technology and innovation. Currently, I am pursuing studies in
              the field of computer science at university of Insubria. I enjoy
              exploring the challenges that computer science presents and
              finding creative solutions to complex problems.
            </p>
            <p className="text-xl p-0 m-0 font-medium text-center pt-3 pb-1 border-accent w-fit">
              Email
            </p>
            <p>lficazzola@studenti.uninsubria.it</p>
          </div>
          <div className="flex flex-col content-start mr-5 w-full">
            <div className="mb-4">
            ...
            <p>nguarini@studenti.uninsubria.it</p>
          </div>
        </div>
      </Container>
    </Layout>
